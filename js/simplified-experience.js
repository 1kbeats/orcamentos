(function simplifiedExperience() {
  ...
  Agenda.detalhes = function(evento) {
    ...
    const actions = CONFIG.canManageOperations ? '<div class="agenda-central-actions"><button class="ops-btn secondary" data-event-action="edit">Editar evento</button><button class="ops-btn secondary" data-event-action="team">Equipe</button><button class="ops-btn secondary" data-event-action="supplier">Fornecedor externo</button><button class="ops-btn secondary" data-event-action="stock">Materiais / estoque</button><button class="ops-btn secondary" data-event-action="finance">Ver financeiro</button><button class="ops-btn" data-event-action="service-order">' + (evento.os ? 'Abrir ordem de serviço' : 'Gerar ordem de serviço') + '</button></div>' : '';
