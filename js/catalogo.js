      ...
      filtered.forEach(item => {
        ...
        row.innerHTML =
          ...
          '<div class="catalog-actions">' +
            (CONFIG.canEditCommercial ? '<button class="btn-edit-cat" type="button" title="Editar" aria-label="Editar item">✎</button>' : '') +
            (CONFIG.isAdmin ? '<button class="btn-del-cat" type="button" title="Excluir" aria-label="Excluir item">✕</button>' : '') +
          '</div>';
