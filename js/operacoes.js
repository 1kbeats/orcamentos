const Operacoes = {
  ...
  semPermissao() {
    ...
    if (target) target.innerHTML = '<div class="ops-page"><div class="ops-empty"><strong>Acesso operacional necessário</strong><br>Este perfil não possui acesso aos dados operacionais.</div></div>';
  },
